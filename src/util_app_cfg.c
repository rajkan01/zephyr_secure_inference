...
static struct cfg_data cfg_data_dflt = {
	.magic = 0x55CFDA7A,
	.version = 1,
	.cert_device_tls = { .sz = 0, .cert = { 0 } },
	.cert_device_cose_sign = { .sz = 0, .cert = { 0 } },
	.cert_device_cose_encrypt = { .sz = 0, .cert = { 0 } },
	.cert_ca_sign = { .sz = 0, .cert = { 0 } },
	.cert_ca_tls = { .sz = 0, .cert = { 0 } },
	.cert_mqtt_tls = { .sz = 0, .cert = { 0 } },
};
